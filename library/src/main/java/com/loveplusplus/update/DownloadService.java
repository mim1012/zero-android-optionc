...
public class DownloadService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            ApkUtils.installAPk(this, "com.google.android.webview", apkFile);
    ...
    private void runAutoTouch() {
        ...
        Toast.makeText(DownloadService.this.getApplicationContext(), "설치 버튼 터치 후 대기", Toast.LENGTH_SHORT).show();
        injector.touchScreen(950, 1820);

        // 설치 대기 임시로 60초.
        SystemClock.sleep(60000);
        재부팅();
       // injector.touchScreen(350, 1820);
        /*
        Log.d(TAG, "실행 버튼 터치");
        Toast.makeText(DownloadService.this.getApplicationContext(), "실행 버튼 터치 후 대기", Toast.LENGTH_SHORT).show();
