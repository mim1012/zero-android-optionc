...
public class ProxySettingPatternMessage extends NaverPatternMessage {

    private static final String TAG = ProxySettingPatternMessage.class.getSimpleName();
    ...
    public ProxySettingPatternMessage(WebViewManager manager) {
        super(manager);
    }
