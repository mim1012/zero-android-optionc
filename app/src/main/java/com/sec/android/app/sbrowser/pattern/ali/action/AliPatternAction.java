...
public class AliPatternAction extends BasePatternAction {

    private static final String TAG = AliPatternAction.class.getSimpleName();
    private static final String JS_INTERFACE_NAME = getRandomName(null);

    public AliPatternAction(WebView webView) {
