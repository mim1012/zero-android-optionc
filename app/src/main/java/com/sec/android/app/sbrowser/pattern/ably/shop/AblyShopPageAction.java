...
public class AblyShopPageAction extends BasePatternAction {

    private static final String TAG = AblyShopPageAction.class.getSimpleName();
    ...
    public AblyShopPageAction(WebView webView) {
    ...
    public InsideData getContentCodeInsideData(String code) {
        return getInsideDataOffset(getContentCodeSelector(code), 40, 10);
    }
