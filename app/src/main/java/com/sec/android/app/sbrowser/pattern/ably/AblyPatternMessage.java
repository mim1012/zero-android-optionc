package com.sec.android.app.sbrowser.pattern.ably;
...
public class AblyPatternMessage extends PatternMessage {

    private static final String TAG = AblyPatternMessage.class.getSimpleName();

    public static final String HOME_URL = "https://m.a-bly.com/";
...
//    protected final NaverSearchBarCheckPatternAction _searchBarCheckPatternAction;
    ...
    public AblyPatternMessage(WebViewManager manager) {
        super(manager);
...
//            }
            ...
            case END_PATTERN: {
                Log.d(TAG, "# AblyPatternMessage 패턴 종료");
