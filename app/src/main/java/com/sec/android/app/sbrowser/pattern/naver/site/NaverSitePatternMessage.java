...
public class NaverSitePatternMessage extends NaverPatternMessage {

    private static final String TAG = NaverSitePatternMessage.class.getSimpleName();
    ...
    private final NaverSitePageAction _viewPageAction;
    ...
    public NaverSitePatternMessage(WebViewManager manager, KeywordItemMoon item) {
        super(manager);
        ...
        _viewPageAction = new NaverSitePageAction(manager.getWebView());
...
//            }
            ...
            case TOUCH_CONTENT: {
                ...
                if (insideData != null) {
                    ...
                    Log.d(TAG, "# 네이버 사이트 컨텐츠 못찾아서 다음으로...");
                    if (_currentPage <= 1) {
                        ++_currentPage;
