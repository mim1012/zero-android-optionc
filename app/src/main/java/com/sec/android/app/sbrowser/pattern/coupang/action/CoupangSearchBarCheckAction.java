...
public class CoupangSearchBarCheckAction {

    private static final String TAG = CoupangSearchBarCheckAction.class.getSimpleName();

    private static final String JS_INTERFACE_NAME = "SearchBarChecker";
    ...
    public CoupangSearchBarCheckAction(WebView webView) {
        _mutex = new Object();
        _webView = webView;
...
//    }
    ...
    private String getSearchBarFocusQuery() {
        return "document.querySelectorAll('.sch_focus, .open_autocomplete')";
    }
