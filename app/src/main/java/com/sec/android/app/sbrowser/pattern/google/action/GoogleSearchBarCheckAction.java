...
public class GoogleSearchBarCheckAction {

    private static final String TAG = GoogleSearchBarCheckAction.class.getSimpleName();
    ...
    public GoogleSearchBarCheckAction(WebView webView) {
        _mutex = new Object();
        _webView = webView;
