package com.sec.android.app.sbrowser.pattern.google;
...
public class GooglePatternMessage extends PatternMessage {

    private static final String TAG = GooglePatternMessage.class.getSimpleName();
    ...
    public GooglePatternMessage(WebViewManager manager) {
        super(manager);
...
//            }
            ...
            case END_PATTERN: {
                Log.d(TAG, "# GooglePatternMessage 패턴 종료");
