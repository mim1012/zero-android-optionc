...
public class AblyPatternAction extends BasePatternAction {

    private static final String TAG = AblyPatternAction.class.getSimpleName();
    private static final String JS_INTERFACE_NAME = getRandomName(null);

    public AblyPatternAction(WebView webView) {
