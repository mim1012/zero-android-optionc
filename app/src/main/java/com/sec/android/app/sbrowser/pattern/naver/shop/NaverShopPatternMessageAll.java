...
public class NaverShopPatternMessageAll extends NaverPatternMessage {

    private static final String TAG = NaverShopPatternMessageAll.class.getSimpleName();
    ...
    public NaverShopPatternMessageAll(WebViewManager manager, KeywordItemMoon item) {
        super(manager);
        _item = item;
