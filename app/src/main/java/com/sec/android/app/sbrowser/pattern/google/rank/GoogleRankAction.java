...
public class GoogleRankAction extends BasePatternAction {

    private static final String TAG = GoogleRankAction.class.getSimpleName();

    protected int _nodeCount = 0;
    protected int _rank = -1;

    public GoogleRankAction(String jsInterfaceName, WebView webView) {
