...
import com.sec.android.app.sbrowser.engine.WebEngine.HttpSimple;
...
public class NaverShopPcPacketPatternMessage extends NaverPatternMessage {

    private static final String TAG = NaverShopPcPacketPatternMessage.class.getSimpleName();
    ...
    public NaverShopPcPacketPatternMessage(WebViewManager manager, KeywordItemMoon item) {
        super(manager, false);
        ...
        _httpEngine = new HttpEngine(_webViewManager.getWebView().getContext(), proxy);
        _httpEngine.setCookieController(_cookieController);
        _httpEngine.setIsPc(true);
...
//            _packetPatternType = KeywordItem.PACKET_PATTERN_TYPE_A_CLICK_VIEW;
            ...
            _isPacketShopHome = true;   // 사러가기도 쇼검으로 포함.
            _mainReferer = true;
            _clickReferer = true;
            _mainCookie = true;
...
//                    cookieManager.clear();
            ...
            case RUN_PACKET: {
                Log.d(TAG, "# 패킷 홈 이동");
                String homeUrl = "https://www.naver.com/";
...
//                        homeUrl = "https://m.search.naver.com/search.naver?sm=mtp_hty.top&where=m&query=";
                    ...
                    _htmlString = _httpEngine.requestUrlWithOkHttpClient("https://www.naver.com/");
                }
...
//                        }
                        ...
                        if (_useNewPacket) {
                            ...
                            if (!TextUtils.isEmpty(genUrl)) {
                                ...
                                _httpEngine.setOrigin("https://www.naver.com");
                                _httpEngine.setReferer("https://www.naver.com/");
...
//                    htmlString = _httpEngine.requestUrlWithOkHttpClient("https://m.shopping.naver.com/");
                    ...
                    //붙여넣기 패킷
                    //https://ac.search.naver.com/nx/ac?q=%EC%9E%90%EC%A0%84%EA%B1%B0%20%EA%B1%B0%EC%B9%98%EB%8C%80&con=0&frm=nv&ans=2&r_format=json&r_enc=UTF-8&r_unicode=0&t_koreng=1&run=2&rev=4&q_enc=UTF-8&st=100&_callback=_jsonp_9
                    String parsed = WebViewManager.keywordEncodeForNaverInclPlus(_keyword);
                    String url = "https://ac.search.naver.com/nx/ac?q=" + parsed + "&con=0&frm=nv&ans=2&r_format=json&r_enc=UTF-8&r_unicode=0&t_koreng=1&run=2&rev=4&q_enc=UTF-8&st=100&_callback=_jsonp_0";
...
//                        URL url2 = new URL("ss");
//                        url2.getQuery();
                        _htmlString = _httpEngine.requestNaverShopGoBuy(_mid);
                    }
                }
                ...
                if (TextUtils.isEmpty(htmlString)) {
                    ...
                    if (_mid2.equals(".")) {
                        if (_step == 0 && _packetPatternType == KeywordItem.PACKET_PATTERN_TYPE_A_CLICK_VIEW) {
                            ...
                            if (!runPageCall(htmlString, "smartstore_products")) {
                                break;
                            }
...
//                                }
            ...
            case RUN_PACKET_VOLT: {
                ...
                _httpEngine.setOrigin("https://search.shopping.naver.com");
...
//                        Log.d("srgsg", jsonData);
            ...
            case RUN_PACKET_AFTER_PRODUCT_DETAIL: {
                ...
                runProductDetailCcCall(_htmlString, "smartstore_products");
            ...
            case RUN_PACKET_AFTER_POPULAR: {
                ...
                if (_useCcPost) {
                    runCcCall(_htmlString, "smartstore_products");
                }
...
//                            _cookieController.setCookie(".naver.com", "NIPD=" + nipd);
    ...
    public boolean requestWorking() {
        ...
        Log.d(TAG, "### requestWorking Url: " + url);
        HttpSimple http = new HttpSimple();
        http.setProxyString(UserManager.getInstance().webProxy);
        String htmlString3 = http.get(url);
...
//        if (sti.equals("smartstore_products")) {
...
//        }
    ...
    public boolean runSearchPageProcess(String targetUrl, String htmlString, Document doc, Element elTagA) {
        ...
        if (_useLcsGet) {
            String url = getLcsUrl(htmlString, "smartstore_products");
...
//            }
            ...
            if (elTagA.size() > 0) {
                ...
                if (TextUtils.isEmpty(targetUrl)) {
                    ...
                    if (!targetUrl.startsWith("https")) {
                        _contentUrl = "https://smartstore.naver.com" + targetUrl;
                    } else {
                        _contentUrl = targetUrl;
                    }
    ...
    private String getHomeMidSelector(String mid) {
        return ".sp_nshop .box:not(._ad) a[href*=mid=" + mid + "].title";
...
//            }
            ...
            if (!sti.equals("m_main_home") && !sti.equals("smartstore_products")) {
    ...
    private String getUaParam(boolean hasModel, boolean hasBrands) throws UnsupportedEncodingException {
        ...
        if (!TextUtils.isEmpty(secUa)) {
            ...
            if (hasModel && !TextUtils.isEmpty(_chromeVersion)) {
                ...
                //Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/111.0.0.0 Safari/537.36#111.0.5563.65
...
//                }
                ...
                paramString.append("&ua_architecture=").append("x86");
                ...
                paramString.append("&ua_platform=").append("Windows");
                paramString.append("&ua_platformVersion=").append("15.0.0");
    ...
    public String getSearchCcBody(String htmlString, boolean isBox) {
        ...
        try {
            ...
            paramString.append("&ssc=").append("navertop.v4");
            ...
            if (TextUtils.isEmpty(_pid)) {
                ...
                if (!TextUtils.isEmpty(htmlString2)) {
                    ...
                    _pid = pid;
                    paramString.append("&p=").append(pid);
                }
            } else {
                paramString.append("&p=").append(_pid);
            }

            paramString.append("&g=").append("[object%20PointerEvent]");
            paramString.append("&lcsurl=").append(URLEncoder.encode(urlString, "UTF-8"));
            paramString.append("&px=0");
            paramString.append("&py=0");
    ...
    public boolean runCcPost(String htmlString, String sti, String py) {
        ...
        if (!TextUtils.isEmpty(genUrl)) {
            ...
            _httpEngine.setOrigin("https://smartstore.naver.com");
            _httpEngine.setReferer("https://smartstore.naver.com/");
            String htmlString3 = _httpEngine.requestUrlPostWithOkHttpClientText(genUrl, jsonBody);
...
//        Elements elTqi = doc.select("input[name=tqi]");
        ...
        //"goOtherCR(this,'u='+urlencode(this.href)+'&r=1&i=00000009_0013c7389b87&a=shp_dui*a.outimg');"
//        String part = _httpEngine.getStringFromSource(eventString, "'", "'");
        ...
        try {
            String x = (int) MathHelper.randomRange(200, 900) + "";
//            String y = (int) MathHelper.randomRange(140, order == 1 ? 380 : 640) + "";
            String y = (int) MathHelper.randomRange(400, 700) + "";
            String py = (int) MathHelper.randomRange(1200, 2500) + "";
...
//        ts:                           1676829908636               1676745658771           1676833332017
        ...
        try {
            ...
            for (String part : parts) {
                ...
                if (part.startsWith("Chrome/")) {
                    String[] values = part.split("Chrome/");
            ...
            tags = "conn_._TLSv1.3_.:alpn.h2:_ssl:ua.chrome." + version;
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
    ...
    public String getShoppingSearchUrl2(String htmlString) {
        ...
        // https://s.search.naver.com/p/sshopping/search.naver?addon_plan=1&bt=-1&category1=50000006&query=%ED%99%8D%EB%AF%B8%EC%A7%91+%EB%8B%AD%EB%B0%9C%EC%96%91%EB%85%90+%EB%8B%AD%EB%B3%B6%EC%9D%8C%ED%83%95%EC%96%91%EB%85%90+%EB%8B%AD%EA%B0%88%EB%B9%84%EC%96%91%EB%85%90%EC%9E%A5+%EB%96%A1%EB%B3%B6%EC%9D%B4%EC%86%8C%EC%8A%A4&rev=43&source=shp_dui&view=GUIDE&where=addon_vertical_api_pc&_callback=jQuery112408569750822351674_1679371715279&_=1679371715280
...
//        String baseUrl = _httpEngine.getValueFromHtml(htmlString, "\"foryouApiUrl\"", ":", ",");
    ...
    public String getShoppingSearchUrl3(String htmlString) {
        ...
        // https://s.search.naver.com/p/sshopping/search.naver?where=recommend_api_pc&bt=-1&query=%ED%99%8D%EB%AF%B8%EC%A7%91+%EB%8B%AD%EB%B0%9C%EC%96%91%EB%85%90+%EB%8B%AD%EB%B3%B6%EC%9D%8C%ED%83%95%EC%96%91%EB%85%90+%EB%8B%AD%EA%B0%88%EB%B9%84%EC%96%91%EB%85%90%EC%9E%A5+%EB%96%A1%EB%B3%B6%EC%9D%B4%EC%86%8C%EC%8A%A4&view=GUIDE&source=shp_dui&filter=relclk&rev=43&ssc=tab.nx.all&sm=top_hty&country=KR&rcode=09290133&region=&city=&lgl_lat=37.6014512&lgl_long=127.0166146&puid=" + g_puid + "&relclk_id={=nvmid}
...
//            }
            ...
            paramString.append("&os=").append(os);
            paramString.append("&ln=").append(URLEncoder.encode("ko-KR", "UTF-8"));
            paramString.append("&sr=").append(URLEncoder.encode("1920x1080", "UTF-8"));
            paramString.append("&pr=").append("1");
            paramString.append("&bw=").append("1903");
            paramString.append("&bh=").append("937");
            paramString.append("&c=").append("24");
            ...
            if (hasBrands) {
                ...
                if (sti.equals("m_main_home")) {
                    int randIndex = (int) MathHelper.randomRange(0, 9);
                    String panName = "";
                    ...
                    paramString.append("&pan=").append(panName);
                    ...
                    if (TextUtils.isEmpty(_pid)) {
                        ...
                        paramString.append("&pid=").append(_pid);
                    }
...
//            parameters.put("abt", "%5B%7B%22eid%22%3A%22SBR1%22%2C%22vid%22%3A%22692%22%7D%5D");    // (g_crt or naver.search.abt_param) + (naver.search.csdark === 1 ? "&stm=dark" : "")
    ...
    public String getRunVoltPvUrl(String urlString) {
        ...
        //https://volts.shopping.naver.com/pv?referer=&nsc=&ts=1686246637258&location=https%3A%2F%2Fsearch.shopping.naver.com%2Fproduct%2F84946754439
    ...
    public String getProductLogUrl(String htmlString) {
        ...
        return "https://smartstore.naver.com/i/v1/product-logs/" + productId;
    }
...
//            jsonObject.put("channelNo", channelNo);
    ...
    public String getCatalogAllUrl(Document doc) {
        ...
        //본링크주소: https://search.shopping.naver.com/catalog/31300176618?cat_id=50002731&frm=MOSCPRO&query=%EB%B8%94%EB%9E%99%EB%B0%95%EC%8A%A4&NaPm=ct%3Dle9hwgds%7Cci%3D0f81bebd2b4f57805f66f9a0e4332ac8473b1956%7Ctr%3Dsls%7Csn%3D95694%7Chk%3D7fdafe43f3feb2a6417aac5053c555395393e161
        //카달페이지: https://search.shopping.naver.com/catalog/31300176618?NaPm=ct%3Dle9hy294%7Cci%3D4b5d6b5c22b191eb75c7326f6a44063e8eb28977%7Ctr%3Dsls%7Csn%3D95694%7Chk%3D58ed7bfbb02c6fab39c6602015fb63f6cb19362b&cat_id=50002731&frm=MOSCPRO&purchaseConditionSequence=20048015&query=%EB%B8%94%EB%9E%99%EB%B0%95%EC%8A%A4%20%EC%95%84%EC%9D%B4%EB%A1%9C%EB%93%9C%20tx5%202%EC%B1%84%EB%84%90&sort=LOW_PRICE
        //전체판매처: https://search.shopping.naver.com/catalog/31300176618/products?NaPm=ct%3Dle9hy294%7Cci%3D4b5d6b5c22b191eb75c7326f6a44063e8eb28977%7Ctr%3Dsls%7Csn%3D95694%7Chk%3D58ed7bfbb02c6fab39c6602015fb63f6cb19362b&cat_id=50002731&frm=MOSCPRO&fromWhere=CATALOG&purchaseConditionSequence=20048014&query=%EB%B8%94%EB%9E%99%EB%B0%95%EC%8A%A4%20%EC%95%84%EC%9D%B4%EB%A1%9C%EB%93%9C%20tx5%202%EC%B1%84%EB%84%90&sort=LOW_PRICE

        StringBuilder genUrl = new StringBuilder("https://search.shopping.naver.com/catalog/" + _mid + "/products?");
