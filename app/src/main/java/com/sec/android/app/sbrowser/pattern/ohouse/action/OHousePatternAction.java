...
public class OHousePatternAction extends BasePatternAction {

    private static final String TAG = OHousePatternAction.class.getSimpleName();
    private static final String JS_INTERFACE_NAME = getRandomName(null);

    public OHousePatternAction(WebView webView) {
