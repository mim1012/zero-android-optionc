...
public class CoupangRankAction extends BasePatternAction {

    private static final String TAG = CoupangRankAction.class.getSimpleName();

    protected int _nodeCount = 0;
    protected int _rank = -1;

    public CoupangRankAction(String jsInterfaceName, WebView webView) {
