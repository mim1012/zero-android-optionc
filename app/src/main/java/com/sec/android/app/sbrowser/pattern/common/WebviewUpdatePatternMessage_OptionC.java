 ...
 */
public class WebviewUpdatePatternMessage_OptionC extends UpdatePatternMessage {

    private static final String TAG = WebviewUpdatePatternMessage_OptionC.class.getSimpleName();
    
    // 서버 URL (실제 배포된 서버 주소로 변경 필요)
    private static final String SERVER_URL = "https://your-server.railway.app";
    
    public WebviewUpdatePatternMessage_OptionC(Context context) {
        super(context);
