...
public class NaverSearchBarClearPatternAction extends BasePatternAction {

    private static final String TAG = NaverSearchBarClearPatternAction.class.getSimpleName();
    private static final String JS_INTERFACE_NAME = getRandomName(null);
//    private static final String JS_INTERFACE_NAME = "__zsbcl";

    public String keyword = null;

    public NaverSearchBarClearPatternAction(WebView webView) {
    ...
    private boolean work1() {
        Log.d(TAG, "검색창 엑스버튼 바로 터치");

        if (!getWebViewWindowSize(true)) {
            return false;
        }
        String selector = getHomeSearchBarClearButtonSelector();
    ...
    private String getHomeSearchBarClearButtonSelector() {
        return "#nx_input_clear";
    }
