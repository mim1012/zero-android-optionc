...
public class NaverPlaceAfterPatternAction extends NaverBasePatternAction {

    private static final String TAG = NaverPlaceAfterPatternAction.class.getSimpleName();
    ...
    public NaverPlaceAfterPatternAction(WebView webView,String url) {
        super(webView);
