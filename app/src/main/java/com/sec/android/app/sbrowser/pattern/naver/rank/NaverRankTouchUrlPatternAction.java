...
public class NaverRankTouchUrlPatternAction extends NaverBasePatternAction {

    private static final String TAG = NaverRankTouchUrlPatternAction.class.getSimpleName();
    private static final String JS_INTERFACE_NAME = getRandomName(null);
//    private static final String JS_INTERFACE_NAME = "FindPlace";
...
//    private static final long MAX_MORE_RUN = 1;
  ...
  String Code;
    ...
    public NaverRankTouchUrlPatternAction(WebView webView, String code) {
        super(webView);
