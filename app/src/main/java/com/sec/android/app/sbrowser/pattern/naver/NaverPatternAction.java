...
public class NaverPatternAction extends BasePatternAction {

    private static final String TAG = NaverPatternAction.class.getSimpleName();
    private static final String JS_INTERFACE_NAME = getRandomName(null);
//    private static final String JS_INTERFACE_NAME = "__znp";

    public NaverPatternAction(WebView webView) {
    ...
    public void inputKeywordForTyping(String keyword) {
        extractStrings(keyword);
        inputKeyword();
    }
    ...
    public void inputText(String text) {
        _touchInjector.sendString(text);
    }

    public void touchSearchButton() {
        // 타입에 따라 버튼 직접 클릭혹은 자판 클릭.
        // 홈페이지 버튼 클릭.
//        touchScreen(1000, 150);
