...
public class CoupangPatternAction extends BasePatternAction {

    private static final String TAG = CoupangPatternAction.class.getSimpleName();
    private static final String JS_INTERFACE_NAME = "PatternAction";

    public CoupangPatternAction(WebView webView) {
