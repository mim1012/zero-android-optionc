...
public class NaverPlacePacketPatternMessage extends NaverPatternMessage {

    private static final String TAG = NaverPlacePacketPatternMessage.class.getSimpleName();
    ...
    public NaverPlacePacketPatternMessage(WebViewManager manager, KeywordItemMoon item) {
        super(manager, false);
